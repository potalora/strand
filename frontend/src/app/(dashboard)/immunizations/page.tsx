...
const RECORD_TYPE = "immunization";
const PAGE_SIZE = 25;
  ...
  return (
    <div className={`screen ${shown ? "on" : ""}`}>
      <div className="page-top">
        <div>
          <p className="kicker">Immunizations</p>
          <h1 className="h1 display">Immunizations</h1>
        </div>
        <SecureChip />
      </div>
      ...
      <div className="card-surface pad">
        {loading ? (
          <RetroLoadingState text="Loading immunizations" />
        ) : records.length === 0 ? (
          <div className="py-8 text-center">
            <p className="muted text-sm mb-3">No immunizations on file.</p>
