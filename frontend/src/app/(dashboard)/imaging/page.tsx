  ...
  return (
    <div className={`screen ${shown ? "on" : ""}`}>
      <div className="page-top">
        <div>
          <p className="kicker">Imaging</p>
          <h1 className="h1 display">Imaging studies</h1>
        </div>
        <SecureChip />
      </div>
      ...
      <div className="card-surface pad">
        {loading ? (
          <RetroLoadingState text="Loading imaging" />
        ) : records.length === 0 ? (
          <div className="py-8 text-center">
            <p className="muted text-sm mb-3">No imaging studies on file.</p>
