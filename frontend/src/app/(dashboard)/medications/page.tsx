  ...
  return (
    <div className={`screen ${shown ? "on" : ""}`}>
      <div className="page-top">
        <div>
          <p className="kicker">Medications</p>
          <h1 className="h1 display">Medications</h1>
        </div>
        <SecureChip />
      </div>
      ...
      <div className="card-surface pad">
        {loading ? (
          <RetroLoadingState text="Loading medications" />
        ) : records.length === 0 ? (
          <div className="py-8 text-center">
            <p className="muted text-sm mb-3">No medications on file.</p>
